<template>
  <div class="q-py-md row q-gutter-sm">
    ...
    <q-btn unelevated color="primary" label="Importar" @click="importCompanies" :disabled="!file" class="col-auto"/>
  </div>
...
async function importCompanies() {
  Loading.show()
  const response = await importsAPI.companies({ file: file.value })
